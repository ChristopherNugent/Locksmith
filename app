...
function test {
    ...
    export DISPLAY=:0
    ./com.github.christophernugent.locksmith --run-tests
    result=$?
...
"generate-i18n")
    initialize
    ninja com.github.christophernugent.locksmith-pot
    ninja com.github.christophernugent.locksmith-update-po
    ;;
"install")
    initialize
    sudo ninja install
...
"run")
    initialize
    ./com.github.christophernugent.locksmith "${@:2}"
    ;;
"test")
    test
    ;;
